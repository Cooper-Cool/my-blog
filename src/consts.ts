export const SITE_URL = 'https://blog.cooper.com';
export const SITE_TITLE = "Cooper's blog";
...
export const PHOTO_ALBUM_CONFIG = {
    shareUrl: 'https://photos.app.goo.gl/yourid',
    title: '生活碎片'
};
...
export const HOME_PROFILE = {
    ...
    rows: [
        ...
        { label: 'contact', value: 'Cooper@vip.qq.com' },
